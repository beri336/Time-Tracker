...
class ArbeitszeitTracker:
    def __init__(self, root):
        ...
        # time label
        self.time_label = tk.Label(self.center_frame, text="00:00:00", font=("Helvetica", 28, "bold"))
        ...
        button_style = {"font": ("Helvetica", 12), "bg": "#4CAF50", "fg": "black", "activebackground": "#388E3C", "activeforeground": "white"}

        self.start_button = tk.Button(self.buttons_frame, text="Start", command=self.start_timer, **button_style)
        self.start_button.grid(row=0, column=0, padx=10, pady=5, sticky="ew")

        self.pause_button = tk.Button(self.buttons_frame, text="Pause", command=self.pause_timer, state="disabled", **button_style)
        self.pause_button.grid(row=0, column=1, padx=10, pady=5, sticky="ew")

        self.continue_button = tk.Button(self.buttons_frame, text="Weiter", command=self.continue_timer, state="disabled", **button_style)
        self.continue_button.grid(row=0, column=2, padx=10, pady=5, sticky="ew")

        self.stop_button = tk.Button(self.buttons_frame, text="Stop", command=self.stop_timer, state="disabled", **button_style)
